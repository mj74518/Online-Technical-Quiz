...
?>
	...
	<?php 
	$ad=$_GET['id'];
	$res3 = $con->query("Select * from admin WHERE admin_id='$ad'");
 	while($row_3 = $res3->fetch_assoc())
	{ 
?>
					...
					<tr><td colspan ="4"><h3>Basic Details- <hr/></h3></td></tr>
						...
						<tr>
							...
							<td colspan="1"><input name="username" type="text" class="form-control" value="<?php echo $row_3['admin_id']; ?>" disabled="disabled"/></td>
						</tr>
						<tr>
							<td colspan="2"><label>Name:</label></td>
							<td colspan="1"><input name="fullname" type="text" class="form-control" value="<?php echo $row_3['admin_name']; ?>"  ></td>
							<td rowspan="3">
							<div class="pfimage" style="margin-left:100px">
							<?php
									if($row_3['pic_status']==1){
						...
						<tr>
							...
							<td colspan="1"><input name="contact" type="text" class="form-control" maxlength="10" value="<?php echo $row_3['contact']; ?>" /></td>
						</tr>
						 ...
						 <tr>
							...
							<td colspan="1">
							<input name="email" type="email" class="form-control" maxlength="80" value="<?php echo $row_3['email']; ?>" /></td>
						</tr>
