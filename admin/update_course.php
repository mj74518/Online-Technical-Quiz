...
<section id="main-content">
		...
		<center>
			...
			<h2><b>Available Course And Details</b></h2>
				<thead>
					<th>Course Name</th>	
					<th>Subject ID</th>	
					<th>Subject Name</th>					
				...
				<tbody>
				<?php
				$result_3 = $con->query("Select * from Subject");
				...
				{ 			
					...
					<tr>
					<td><?php 
					$cours_id=$row_3['course_id'];
					$result_4 = $con->query("Select course_name from Course WHERE course_id='$cours_id'");
					while($row_4 = mysqli_fetch_array($result_4))
					{
					echo $row_4['course_name']; 
					}
					?></td>
					
					<td><?php echo $row_3['sub_id']; ?></td>
					<td><?php echo $row_3['sub_name']; ?></td>
													
					<td>
						<a href='edit_course.php?id=<?php echo $row_3['sub_id']?>' data-toggle="tooltip" data-placement="top" title="Update Quiz">
						<span class="glyphicon glyphicon-edit" style="font-size:20px; color:black;"></span></a>
					</td>
					<td>
						<a href='remove_subject.php?id=<?php echo $row_3['sub_id']; ?>' data-toggle="tooltip" data-placement="top" title="Remove Subject">
