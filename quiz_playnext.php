...
while($row=mysqli_fetch_array($q) )
{
	...
	{
		$s_no=$s_no+1;
		$query="INSERT INTO `answer` (`user_id`, `test_id`, `que_id`, `correct_ans`, `user_ans`) VALUES('$user_id', '$test_id', '$que_id', '$correct_ans', '$user_ans')";
	...
	elseif($s_no = $total)
	{
		...
		$unattempted=$total-$rows;
			...
			echo "<script> location.href = 'result.php?test_id=$test_id';</script>";
			}
			}	
			}
		}
